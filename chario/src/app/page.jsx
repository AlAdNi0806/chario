        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <p className="text-lg text-white/70 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Charities from all over the world are using our platform to raise funds for their causes. Knowing trust is essential for a successful charity. We are here to help you achieve your goals.
            </p>
          </motion.div>
